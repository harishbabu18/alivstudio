...
<body id="top">
    <header class="bg-light">
      <nav class="navbar navbar-expand-lg navbar-light bg-light" id="header-nav" role="navigation">
        <div class="container"><a class="link-dark navbar-brand site-title mb-0" href="#">ALIV STUDIO</a>
  ...
  <div class="cover bg-light">
    <div class="container px-2">
      <div class="row">
        ...
        <div class="col-lg-6 p-3 pe-lg-0" data-aos="fade-left" data-aos-delay="100"><asset:image class="pt-2 img-fluid" src="illustrations/building_websites.svg" absolute="true"/></div>
      </div>
    </div>
  </div>
...
<div class="section pt-3 pt-lg-5 px-2 px-lg-4" id="about">
  ...
  <div class="container">
    <div class="row py-3 py-lg-5">
      <div class="col-lg-6 col-md-5 px-3 order-md-last" data-aos="fade-zoom-in" data-aos-delay="50" data-aos-easing="ease-in-back"><img class="my-3 img-fluid" src="illustrations/development.svg" alt="development"/></div>
    ...
    <div class="row py-3 py-lg-5">
      <div class="col-lg-6 col-md-5 px-3" data-aos="fade-zoom-in" data-aos-delay="50" data-aos-easing="ease-in-back"><asset:image class="my-3 img-fluid" src="illustrations/creative-team.svg" alt="creative-team"/></div>
      <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
    ...
    <div class="row py-3 py-lg-5">
      <div class="col-lg-6 col-md-5 px-3 order-md-last" data-aos="fade-zoom-in" data-aos-delay="50" data-aos-easing="ease-in-back"><asset:image class="my-3 img-fluid" src="illustrations/work-chat.svg" alt="work-chat"/></div>
      <div class="col-lg-6 col-md-7 px-2" data-aos="zoom-in" data-aos-delay="100">
...
<div class="section py-3 py-lg-5 px-2 px-lg-4" id="clients">
  <div class="container-narrow">
    ...
    <div class="text-center" data-aos="zoom-in-up" data-aos-delay="100">
      <div class="mx-auto mb-3"> <asset:image class="p-1" src="clients/client1.png"/><asset:image class="p-1" src="clients/client2.png"/><asset:image class="p-1" src="clients/client3.png"/><asset:image class="p-1" src="clients/client4.png"/><asset:image class="p-1" src="clients/client5.png"/><asset:image class="p-1" src="clients/client6.png"/><asset:image class="p-1" src="clients/client7.png"/></div>
    </div>
  </div>
</div>
  ...
  <div class="container-narrow">
    ...
    <div class="row py-3">
      <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="100">
        <div class="bg-white border rounded-circle d-inline-block p-2"><asset:image class="p-2" src="services/web-design.svg" width="96" height="96" alt="web design"/></div>
      ...
      <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="200">
        <div class="bg-white border rounded-circle d-inline-block p-2"><asset:image class="p-2" src="services/graphic-design.svg" width="96" height="96" alt="graphic design"/></div>
        <div class="bg-white border rounded p-3 mt-n4">
      ...
      <div class="col-md-4 text-center mb-3" data-aos="fade-up" data-aos-delay="300">
        <div class="bg-white border rounded-circle d-inline-block p-2"><asset:image class="p-2" src="services/ui-ux.svg" width="96" height="96" alt="ui-ux"/></div>
        <div class="bg-white border rounded p-3 mt-n4">
    ...
    <div class="container-narrow">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="6000">
          <div class="row">
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-1.jpg" alt="image"/>
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-2.jpg" alt="image"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-3.jpg" alt="image"/>
                <div class="card-body text-center">
        ...
        <div class="carousel-item">
          <div class="row">
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-4.jpg" alt="image"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-5.jpg" alt="image"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><asset:image class="card-img-top" src="team/emp-6.jpg" alt="image"/>
                <div class="card-body text-center">
  ...
  <div class="container">
    ...
    <div class="grid bp-gallery pb-3" data-aos="zoom-in-up" data-aos-delay="100">
      ...
      <div class="grid-item"><a href="https://dribbble.com">
          <figure class="portfolio-item"><asset:image src="portfolio/1-small.png" data-bp="portfolio/1.jpg"/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://github.com">
          <figure class="portfolio-item"><asset:image src="portfolio/2-small.png" data-bp="portfolio/2.jpg" data-caption="Example of an optional caption."/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://soundcloud.com/">
          <figure class="portfolio-item"><asset:image src="portfolio/3-small.png" data-bp="portfolio/3.jpg" data-caption="Example of an optional caption."/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://www.adobe.com/">
          <figure class="portfolio-item"><asset:image src="portfolio/4-small.png" data-bp="portfolio/4.jpg"/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://www.adobe.com/">
          <figure class="portfolio-item"><asset:image src="portfolio/5-small.png" data-bp="portfolio/5.jpg"/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://www.android.com/">
          <figure class="portfolio-item"><asset:image src="portfolio/6-small.png" data-bp="portfolio/6.jpg"/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://flutter.dev/">
          <figure class="portfolio-item"><asset:image src="portfolio/7-small.png" data-bp="portfolio/7.jpg"/>
            <figcaption>
      ...
      <div class="grid-item"><a href="https://flutter.dev/">
          <figure class="portfolio-item"><asset:image src="portfolio/8-small.png" data-bp="portfolio/8.jpg"/>
            <figcaption>
              <h4 class="h5 mb-0">App Development</h4>
              <div>Flutter</div>
            </figcaption>
    ...
    <div class="row">
      <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
        ...
        <div class="d-flex justify-content-end align-items-end">
          ...
          </div><asset:image class="me-md-3 rounded" src="testimonials/client1.jpg" width="96" height="96" alt="client 1"/>
        </div>
      </div>
      <div class="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="d-flex justify-content-end align-items-end">
          ...
          </div><asset:image class="me-md-3 rounded" src="testimonials/client2.jpg" width="96" height="96" alt="client 1"/>
        </div>
      </div>
      <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
        ...
        <div class="d-flex justify-content-end align-items-end">
          ...
          </div><asset:image class="me-md-3 rounded" src="testimonials/client3.jpg" width="96" height="96" alt="client 1"/>
        </div>
      </div>
      <div class="col-md-6 mb-5" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="d-flex justify-content-end align-items-end">
          ...
          </div><asset:image class="me-md-3 rounded" src="testimonials/client4.jpg" width="96" height="96" alt="client 1"/>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="mt-5 px-2">
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="pb-1 fw-bolder">contact</div>
            </div>
            <div class="col-sm-2">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-6 mb-3">
        ...
        <div class="text-small">
          ...
          <div class="mb-1"><strong>Phone:</strong><br/>+91-8667710055</div>
